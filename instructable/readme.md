...
stap 7
steek de finale code via arduino IDE in de arduino Nano.

stap 8
open Serial Bluetooth Terminal.

stap 9
Verbindt via Bluetooth LE met DSD tech.

stap 10
test eerst of de motoren draaien door (set kp 0) en (run) in te geven in de terminal. Als ze beide voorwaarts draaien is het goed anders moet je in de finale code de pinnummers omdraaien.

stap 11
Kijk in de gebruiksaanwijzing hoe je de parameters ingeeft.
